...
use mbforge_infra::helpers::SMILES_RE;

use mbforge_pipeline::chem::association::{self, ActivityEntry};
...
) -> Vec<mbforge_infra::types::ExtractionResult> {
    use crate::commands::extractor::extract_esmiles_with_positions;
    use mbforge_infra::types::ExtractionResult;
