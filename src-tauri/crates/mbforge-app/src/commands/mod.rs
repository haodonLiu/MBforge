...
pub fn handler() -> impl Fn(tauri::ipc::Invoke<tauri::Wry>) -> bool + Send + Sync + 'static {
    tauri::generate_handler![
        ...
        // knowledge_base
        mbforge_domain::document::knowledge_base::kb_search,
        mbforge_domain::document::knowledge_base::kb_search_stream,
        mbforge_domain::document::knowledge_base::kb_get_structure,
        mbforge_domain::document::knowledge_base::kb_get_pages,
        ...
        mbforge_domain::project::resource_manager::resources_check,
        mbforge_domain::project::resource_manager::resources_status,
        mbforge_domain::project::resource_manager::resources_get_model_path,
        mbforge_domain::project::resource_manager::resources_catalog,
        mbforge_domain::project::resource_manager::models_download,
        mbforge_domain::project::resource_manager::models_download_subfile,
        mbforge_domain::project::resource_manager::models_cancel_download,
        mbforge_domain::project::resource_manager::models_delete,
        mbforge_domain::project::resource_manager::models_delete_subfile,
        mbforge_domain::project::resource_manager::models_test,
        mbforge_domain::project::resource_manager::models_cache_dir_info,
