...
impl Project {
    pub fn open(root: &Path) -> Option<Self> {
        ...
        if version < PROJECT_FORMAT_VERSION {
            ...
            let _ = crate::core::helpers::save_json(&version_path, &version_data);
        }
...
mod tests {
    use super::*;
    use crate::core::config::constants::PROJECT_SOURCE_FILE;
    use std::io::Write;
    ...
    fn test_remove_document_cleans_orphaned_data() {
        ...
        use crate::core::document::summary::{DocumentSummary, SummaryManager};
