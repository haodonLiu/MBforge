...
fn check_markush_mention(
    ...
    let (score, details) = match overlap.match_level {
        ...
        mbforge_chem::markush::MatchLevel::PartialOverlap => (
            0.7,
            format!(
        ...
        mbforge_chem::markush::MatchLevel::ScaffoldOverlap => (
            0.5,
            format!(
        ...
        mbforge_chem::markush::MatchLevel::NoOverlap => {
            return Some(ClaimPolicyMatch {
                claim_number: claim.claim_number,
                compound_name: compound.molecule.name.clone(),
                match_score: 0.0,
...
mod tests {
    use super::*;
    use crate::chem::claim_parser::{ClaimType, PatentClaim};
    use crate::chem::molecule_extractor::{NameType, NamedMolecule};
