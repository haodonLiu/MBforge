...
import LibrarySection, { type CapabilityStatus } from '@/components/settings/LibrarySection'
...
import type { ModelInfo, ModelPaths } from '@/components/settings/envTypes'
import { resourcesCatalog, resourcesStatus, modelsCacheDirInfo, refreshResolvedPaths } from '@/api/http/environment'
import { saveSettings } from '@/api/http/settings'
import { environmentCheck } from '@/api/http/sidecar'
