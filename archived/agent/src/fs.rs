...
pub fn native_list_files(root: &str, pattern: &str, max_results: usize) -> String {
...
pub fn native_read_file(root: &str, file_path: &str, max_lines: usize) -> String {
...
pub fn native_get_project_info(root: &str) -> String {
...
pub fn native_glob_search(root: &str, pattern: &str, max_results: usize) -> String {
