...
use mbforge_pipeline::doc_types::{ImageRef as DocImageRef, OcrBlock as DocOcrBlock};
use mbforge_pipeline::pipeline::context::PipelineContext;
use mbforge_pipeline::pipeline::models::enriched::DetectedMoleculeResult;
use mbforge_pipeline::pipeline::models::extracted::{ImageRef, OcrBlock};
use mbforge_pipeline::pipeline::models::source::SourceInput;
use mbforge_pipeline::pipeline::runner::Stage;
use mbforge_pipeline::pipeline::services::molecules::MoleculeService;
use mbforge_pipeline::pipeline::services::ocr::{default_backends, OcrService};
use mbforge_pipeline::pipeline::services::ocr_layout::{get_ocr_layout, OcrLayoutBlock};
use mbforge_pipeline::pipeline::services::source::SourceResolver;
use mbforge_pipeline::pipeline::stages::extract::ExtractStage;
use mbforge_pipeline::pipeline::writer::markdown_augment;
...
pub async fn ingest_get_logs(
    ...
    doc_id: String,
    limit: Option<usize>,
) -> Result<Vec<mbforge_domain::ingest_queue::IngestLogRecord>, String> {
    let q = open_ingest_queue(&project_root)?;
