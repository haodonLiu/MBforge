...
pub fn available_backends() -> Vec<Box<dyn OcrBackend>> {
    vec![
        Box::new(crate::ocr::mineru::MineruBackend),
        Box::new(crate::ocr::uniparser::UniparserBackend),
        Box::new(crate::ocr::paddle::PaddleOnlineBackend),
        Box::new(crate::ocr::paddle::PaddleLocalBackend),
    ]
}
