...
//! - [`super::fs`]        file system search / read / list
//! - [`super::kb`]        knowledge base search / structure & pages
//! - [`super::document`]  document abstracts / overviews / listing
//! - [`super::molecule`]  molecule analysis + Markush overlap
//! - [`super::literature`]  arXiv / PMC paper access
//!
//! The orchestrator below wires them all into a single [`super::tools::ToolRegistry`]
...
fn register_native_tools(registry: &mut ToolRegistry, project_root: &str) {
    super::fs::register(registry, project_root);
    super::kb::register(registry, project_root);
    super::document::register(registry, project_root);
    super::molecule::register(registry, project_root);
    super::literature::register(registry, project_root);
}
