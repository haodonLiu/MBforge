...
pub fn esmiles_to_molecode(
    esmiles: &str,
    name: &str,
) -> Result<crate::molecode::MoleCodeResult, String> {
    crate::molecode::esmiles_to_molecode(esmiles, name)
}
...
pub fn smiles_to_molecode(
    ...
    crate::molecode::smiles_to_molecode(smiles, name)
}

/// SMILES → E-SMILES（添加 `<sep>` + 标签）
pub fn smiles_to_esmiles(smiles: &str, tags: &[crate::esmiles::EsTag]) -> String {
    crate::esmiles::smiles_to_esmiles(smiles, tags)
}
